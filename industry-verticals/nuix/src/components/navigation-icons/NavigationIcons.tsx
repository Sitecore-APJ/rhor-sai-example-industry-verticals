...
const IconDropdown = ({
  ...
  <Popover>
    <PopoverTrigger
      className="text-foreground hover:text-brand data-[state=open]:text-accent transition-colors"
      aria-label={label}
    >
      {icon}
    </PopoverTrigger>
      ...
      <div className={`component navigation-icons ${props?.params?.styles?.trimEnd()}`} id={id}>
        <div className="flex items-center gap-3 p-4 lg:gap-5 [.component.header_&]:justify-end [.component.header_&]:px-0">
          <button
            ...
            className="text-foreground hover:text-brand p-2 transition-colors"
          >
