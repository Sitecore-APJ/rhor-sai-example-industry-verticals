    ...
    >
      <div className="flex items-center justify-center gap-1">
        <Link
          ...
          className="hover:text-brand text-foreground text-sm font-medium whitespace-nowrap transition-colors lg:text-[15px]"
        >
          ...
          className={clsx(
            ...
            hasDropdownMenu &&
              clsx(
                ...
                'lg:border-border/70 lg:bg-background lg:rounded-lg lg:border lg:shadow-lg',
                isActive
                  ? 'max-lg:flex'
