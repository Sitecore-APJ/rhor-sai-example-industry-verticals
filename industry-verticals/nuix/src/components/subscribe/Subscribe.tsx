          ...
          <form className="w-full md:max-w-lg" action="">
            ...
            <div className="relative">
              <input
                ...
                className="bg-background ring-foreground/10 text-foreground placeholder:text-foreground/70 h-12 w-full rounded-full ps-5 pe-32 ring-1 focus:ring-2 focus:outline-none md:h-14"
              />

              <button
                type="submit"
                className="bg-brand group-[.container-dark-background]:bg-background group-[.container-color-background]:bg-background group-[.container-dark-background]:text-foreground! group-[.container-color-background]:text-foreground! text-background absolute top-1/2 right-2 h-9 -translate-y-1/2 rounded-full px-5 text-sm font-semibold tracking-wide uppercase hover:opacity-95 focus-visible:ring-2 focus-visible:outline-none md:right-3 md:h-10 md:px-6"
              >
      ...
      <div className="max-w-sm">
        ...
        <form className="w-full" action="">
          ...
          <input
            ...
            className="bg-background text-foreground placeholder:text-foreground/70 ring-foreground/10 h-12 w-full rounded-full ps-5 pe-5 ring-1 focus:ring-2 focus:outline-none md:h-14"
          />

          <button
            type="submit"
            className="bg-brand group-[.container-dark-background]:bg-background group-[.container-color-background]:bg-background text-background group-[.container-dark-background]:text-foreground! group-[.container-color-background]:text-foreground! mt-3 inline-flex h-12 w-full items-center justify-center rounded-full font-semibold tracking-widest uppercase hover:opacity-95 md:h-12"
          >
            {t('button_text') || 'Subscribe'}
          </button>
